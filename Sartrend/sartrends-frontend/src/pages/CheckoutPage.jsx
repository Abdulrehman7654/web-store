...
export const Field = ({ label, id, type = 'text', value, onChange, required = true, placeholder, error }) => (
  <div className="mb-4">
      ...
      <main className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 mt-8">
        <section className="lg:col-span-8">
          ...
          <div className="space-y-6">
            {step === STEPS.SHIPPING && <ShippingCard form={form} onChange={onChange} errors={errors} steps={STEPS} setStep={setStep} validateShipping={validateShipping}/>}
